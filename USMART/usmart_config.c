...
extern void set_t1_t2(uint8_t tt1,uint8_t tt2);									  
//函数名列表初始化(用户自己添加)
...
struct _m_usmart_nametab usmart_nametab[]=
{
	...
	(void*)LTDC_Layer_Window_Config,"void LTDC_Layer_Window_Config(u8 layerx,u16 sx,u16 sy,u16 width,u16 height,u8 pixformat)", 				
	(void*)LTDC_Clear,"void LTDC_Clear(u32 color)", 
		
	(void*)set_t1_t2,"void set_t1_t2(uint8_t tt1,uint8_t tt2)",
};						  
///////////////////////////////////END///////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
//函数控制管理器初始化
